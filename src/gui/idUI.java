...
import javax.swing.JTextField;
    ...
    public class idUI extends JFrame {
        ...
        public idUI(){
            ...
            label2.setFont(new Font("bold",Font.BOLD , 16));
            label.setForeground(Color.black);
            label1.setForeground(Color.black);
            label2.setForeground(Color.black);
            label.setBounds(0, 0, 600, 150);
            label1.setBounds(142, 140, 120, 30);
            label2.setBounds(156, 180, 80, 30);
            ...
            idField.setBounds(230, 140, 200, 30);
            idField.setForeground(Color.black);
            mainPanel.add(idField);
            surField = new JTextField();
            surField.setBounds(230, 180, 200, 30);
